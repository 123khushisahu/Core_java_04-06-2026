...
/**
 Below program expalins
	...
	6. class literal with PDT, classname  and array
*/
	...
	public static void main(String[] args) {
		...
		//6. Null type literals
			//System.out.println(null);	//Null literal type is 'any referenced type'
										//because null does not have specific type,
										//if we pass null directly to Sopln(), it leads to
		...
		//7. Class type literals [DTname.class] [DTname can be either PDT or RDT name]
			...
			System.out.println(DataType.class);	//Class literal of type java.lang.Class 
			System.out.println(int.class);		//Class literal of type java.lang.Class 
